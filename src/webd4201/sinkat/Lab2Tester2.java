...
public class Lab2Tester2 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			mainStudent = new Student(possibleId, "password", "Robert",
					"McReady", "bob.mcready@dcmail.ca", enrol, lastAccess, 's',
					true, "CPA", "Computer Programmer Analyst", 3);
			// mainStudent.dump();
			try {
				...
				try // attempt to get a Student that does exist
			{
				System.out
						.println("\nAttempt to retrieve a student that does exist (Id: "
								+ existingId + ")");
				dbStudent = Student.retrieve(existingId);
				...
				try {
					...
					mainStudent
							.setProgramDescription("Registered Practical Nurse");
				...
				{
					System.out
							.println("\nAttempt to my own student object (Id: "
									+ myId + ")");
					dbStudent = Student.retrieve(myId);
